...
typedef struct playerState_s {
	...
	int			forceHandExtend; // 1272
	int			forceHandExtendTime; // 1276
	...
	int			heldByClient; //can only be a client index - this client should be holding onto my arm using IK stuff. - 1388
