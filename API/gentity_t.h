...
#include "../jka/game/b_public.h" // For npcs
#include "../jka/game/g_public.h"
#include "../jka/game/bg_vehicles.h"

// Contain a client ptr
#include "gclient_t.h"

typedef struct SpawnData_s SpawnData_t;
...
#define FL_PAY					0x08000000 //Lugormod I can be paid
//RoboPhred
...
// RoboPhred: This should be a client thing...
//typedef 
enum 
{
	HL_NONE = 0,
